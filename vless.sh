...
if [ "$ARCH" == "arm" ] || [ "$ARCH" == "arm64" ] || [ "$ARCH" == "aarch64" ]; then
    ...
    FILE_INFO=("https://github.com/cloudflare/cloudflared/releases/latest/download/cloudflared-fips-linux-amd64 node" "https://github.com/eooce/test/releases/download/freebsd/sb http" "https://raw.githubusercontent.com/leung7963/serv00-vmess/main/nezha-agent php")
else
