...
install_singbox() {
    ...
    curl -sLo "${work_dir}/qrencode" "https://$ARCH.2go.us.kg/qrencode"
    curl -sLo "${work_dir}/sing-box" "https://$ARCH.2go.us.kg/sbx"
    curl -sLo "${work_dir}/argo" "https://$ARCH.2go.us.kg/bot"
